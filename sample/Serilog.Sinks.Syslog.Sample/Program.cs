...
namespace Serilog.Sinks.Syslog.Sample
{
    static class Program
    {
        ...
        private static readonly string baseDir = Path.GetDirectoryName(typeof(Program).GetTypeInfo().Assembly.Location);
        ...
        static async Task Main(string[] args)
        {
            ...
            var tcpConfig = new SyslogTcpConfig
            {
                ...
                CertValidationCallback = (sender, certificate, chain, sslPolicyErrors) => true
            };
